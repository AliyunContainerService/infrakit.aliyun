# REPO
REPO?=github.com/AliyunContainerService/infrakit.aliyun
...
binaries: clean
	@echo "+ $@"
	@go build -o ./build/infrakit-instance-aliyun \
	...
	@cp ./build/infrakit-instance-aliyun ../../docker/infrakit/build/infrakit-instance-aliyun
